                    ...
                    <a href="" class="">
                        ...
                        <div
                            ...
                            <p
                                ...
                                placeat.</p>
                            <div
                                class="border border-transparent rounded hover:bg-[#F69679]  px-8 py-8 mb-3 text-base  text-white duration-300 opacity-0 transition-opacity group-hover:opacity-100">
                                See More</div>
                        </div>
                    </a>
                </div>
