<x-guest-layout>
    ...
    <section class="container mx-auto p-8 ">
        ...
        <div class="grid grid-rows-3 grid-flow-col gap-4 text-center w-full content-center pb-10  rounded-lg">
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-4 ">
                        @for ($x = 0; $x < 6; $x++)
                            <div id="carousel" data-carousel="slide"
                                class="relative max-w-sm md:h-fit md:mb-4  hover:shadow-lg hover:rounded-lg  ">
                                <div class="relative overflow-hidden md:h-36 md-w-full rounded-t-lg">
                                    @for ($i = 0; $i < 4; $i++)
                                        <div class="hidden duration-700 ease-in-out " data-carousel-item>
                                            <a href="/itsMeCJ/I-will-create">
                                                <img class="rounded-t-lg aspect-auto object-cover absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="mb-3 font-normal text-gray-700 text-justify ">Lorem Ipsum is simply dummy
                                        text of the
