<x-guest-layout>
    ...
    <section>
        <div class="container mx-auto grid grid-cols-2 gap-4 p-8">
            <div class="">
                <div class="mb-12">
                    <div class="text-2xl mb-2 font-bold">About Their Services </div>
                    <div>
                        ...
                        @for ($i = 0; $i < 4; $i++)
                            <div class="hidden duration-700 ease-in-out" data-carousel-item="active"
                                ...
                                <div class="cursor-pointer">
                                    <div class="relative skew-y-12 font-extrabold text-9xl text-center opacity-5">
                                        OwlEvent
                                    </div>
                                    <div class="relative skew-y-12 font-extrabold text-9xl text-right opacity-5">
                                        OwlEvent
                                    </div>
                                    <div class="relative  skew-x-12 font-extrabold text-9xl text-left opacity-5">
                                        OwlEvent
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="relative ">
                            ...
                            <div class="cursor-pointer absolute inset-0">
                                <div class=" skew-y-12 font-extrabold text-9xl text-center opacity-5">
                                    OwlEvent
                                </div>
                                <div class=" skew-y-12 font-extrabold text-9xl text-right opacity-5">
                                    OwlEvent
                                </div>
                                <div class="  skew-x-12 font-extrabold text-9xl text-left opacity-5">
                                    OwlEvent
                                </div>
                                <div class=" skew-y-12 font-extrabold text-9xl text-center opacity-5">
                                    OwlEvent
